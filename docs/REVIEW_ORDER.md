...
| 19  | `Compression.Abstractions`             | ✅     | 100% coverage across IKyrolusCompressor, IKyrolusCompressionProvider, KyrolusCompressionAlgorithm contracts                                                            |
...
4. Public types carry XML docs that say _why_, not just _what_
