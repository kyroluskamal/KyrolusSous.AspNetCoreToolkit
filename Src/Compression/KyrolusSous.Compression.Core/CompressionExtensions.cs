...
public static class CompressionExtensions
{
    ...
    /// </summary>
    public static byte[] Compress(this byte[] data, CompressionAlgorithm algorithm = CompressionAlgorithm.Brotli) =>
    ...
    /// </summary>
    public static byte[] Compress(this ReadOnlySpan<byte> data, CompressionAlgorithm algorithm = CompressionAlgorithm.Brotli) =>
        KyrolusCompressionProvider.Instance.GetCompressor(algorithm).Compress(data);

    /// <summary>
    /// Decompresses a compressed byte array using the specified algorithm (defaults to Brotli).
    /// </summary>
    public static byte[] Decompress(this byte[] compressedData, CompressionAlgorithm algorithm = CompressionAlgorithm.Brotli) =>
    ...
    /// </summary>
    public static byte[] Decompress(this ReadOnlySpan<byte> compressedData, CompressionAlgorithm algorithm = CompressionAlgorithm.Brotli) =>
        KyrolusCompressionProvider.Instance.GetCompressor(algorithm).Decompress(compressedData);

    /// <summary>
    /// Compresses a UTF-8 string into a Base64-encoded compressed string.
    /// </summary>
    public static string CompressString(this string text, CompressionAlgorithm algorithm = CompressionAlgorithm.Brotli)
    {
    ...
    /// </summary>
    public static string DecompressString(this string base64Compressed, CompressionAlgorithm algorithm = CompressionAlgorithm.Brotli)
    {
