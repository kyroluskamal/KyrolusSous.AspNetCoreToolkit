    ...
    where TKey : notnull, IEquatable<TKey>
{
    ...
    public Task<IResult> HandleRemoveAsync([FromRoute] TKey id, [FromQuery] bool? cacheable = null);
    public Task<IResult> HandleRemoveRangeAsync([FromBody] IEnumerable<TModel> model, [FromQuery] bool? cacheable = null);
    public Task<IResult> HandlePatchAsync([FromRoute] TKey id, [FromBody] Dictionary<string, object> updates, [FromQuery] bool? cacheable = null);
}
