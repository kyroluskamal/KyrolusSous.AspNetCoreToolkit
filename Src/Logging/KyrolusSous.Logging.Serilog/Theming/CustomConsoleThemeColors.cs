...
/// <summary>
/// Pre-configured theme color dictionaries for <see cref="CustomConsoleTheme"/>.
/// </summary>
public static class CustomConsoleThemeColors
{
    private const string WhiteText = "\u001b[37m";

    public static CustomConsoleTheme VisualStudioMacLight { get; } = new(new Dictionary<ConsoleThemeStyle, string>
    {
    ...
    public static CustomConsoleTheme Dracula { get; } = new(new Dictionary<ConsoleThemeStyle, string>
    {
    ...
    public static CustomConsoleTheme Nord { get; } = new(new Dictionary<ConsoleThemeStyle, string>
    {
    ...
    public static CustomConsoleTheme OneDark { get; } = new(new Dictionary<ConsoleThemeStyle, string>
    {
    ...
    public static CustomConsoleTheme Cyberpunk { get; } = new(new Dictionary<ConsoleThemeStyle, string>
    {
    ...
    public static CustomConsoleTheme MonokaiPro { get; } = new(new Dictionary<ConsoleThemeStyle, string>
    {
    ...
    public static CustomConsoleTheme GitHubDark { get; } = new(new Dictionary<ConsoleThemeStyle, string>
    {
    ...
    public static CustomConsoleTheme SolarizedDark { get; } = new(new Dictionary<ConsoleThemeStyle, string>
    {
