...
public sealed class RuntimeFilterExpressionBuilderIntegrationTests(TestAppFactory factory) : IClassFixture<TestAppFactory>
{
    ...
    public static IEnumerable<object?[]> OrderExpressionCases()
    {
        ...
        yield return OrderCase("lines-all-quantity-gte1", "Lines all Quantity>=1", HttpStatusCode.OK, 3);
        yield return OrderCase("lines-all-quantity-gt1", "Lines all Quantity>1", HttpStatusCode.OK, 2);
