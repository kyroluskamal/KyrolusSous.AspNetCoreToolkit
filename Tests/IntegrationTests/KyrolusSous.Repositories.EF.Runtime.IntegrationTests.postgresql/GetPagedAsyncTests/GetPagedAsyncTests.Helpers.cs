...
{
    private sealed class TestPagedSpecification<TEntity, TResult> : IKyrolusPagedQuerySpecification<TEntity, TResult>, IKyrolusHasSplitQuery
    {
    ...
    private sealed class TestPagedSpecificationWithoutSplit<TEntity, TResult> : IKyrolusPagedQuerySpecification<TEntity, TResult>
    {
        public Expression<Func<TEntity, bool>>? Filter { get; init; }
        public required Expression<Func<TEntity, TResult>>? Selector { get; init; }
        public Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>>? OrderBy { get; init; }
        ...
        string? sku = null)
    {
        ...
        return new Product
        {
            ...
            Name = name ?? $"PagedProduct-{token}",
            Sku = sku ?? $"PGD-{token}",
            Price = 90m,
            AddedIn = new DateOnly(2026, 12, 15),
