...
72 projects, 66,804 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.ExceptionHandling.FluentValidation` | 2 | 50 | ExceptionHandling.Abstractions |
...
| `KyrolusSous.ExceptionHandling.Runtime` | 34 | 999 | ExceptionHandling.Abstractions |
...
| `KyrolusSous.Compression.Core` | 6 | 546 | Compression.Abstractions |
...
| `KyrolusSous.Compression.Lz4` | 3 | 142 | Compression.Abstractions, Compression.Core |
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Caching.Abstractions` | 30 | 2,269 | Compression.Abstractions |
| `KyrolusSous.Caching.MessagePack` | 3 | 138 | Caching.Abstractions |
| `KyrolusSous.Caching.Redis` | 24 | 4,429 | Caching.Abstractions |
...
| `KyrolusSous.Mapping.Runtime` | 12 | 1,636 | Mapping.Abstractions |
