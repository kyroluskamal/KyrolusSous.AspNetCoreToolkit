...
99 projects, 84,464 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.IRabbitMQUtilsInterfaces` | 7 | 128 | - |
| `KyrolusSous.RabbitMQUtils` | 6 | 494 | IRabbitMQUtilsInterfaces |
