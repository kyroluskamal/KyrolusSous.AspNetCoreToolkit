...
119 projects, 95,251 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.FeatureManagement.Abstractions` | 1 | 35 | - |
| `KyrolusSous.FeatureManagement.Core` | 1 | 231 | FeatureManagement.Abstractions |
| `KyrolusSous.FeatureManagement.Redis` | 1 | 51 | FeatureManagement.Abstractions |
| `KyrolusSous.Gateway.Abstractions` | 1 | 32 | - |
| `KyrolusSous.Gateway.Yarp` | 1 | 143 | Auth.TokenRevocation, Gateway.Abstractions |
| `KyrolusSous.Http.Abstractions` | 1 | 36 | - |
| `KyrolusSous.Http.Core` | 1 | 166 | Http.Abstractions, Resilience.Abstractions |
...
| `KyrolusSous.Scheduling.Core` | 1 | 273 | Scheduling.Abstractions |
| `KyrolusSous.Scheduling.Redis` | 1 | 53 | Scheduling.Abstractions |
| `KyrolusSous.Storage.Abstractions` | 3 | 259 | Compression.Abstractions |
| `KyrolusSous.Storage.FileSystem` | 1 | 301 | Storage.Abstractions |
| `KyrolusSous.Storage.S3` | 1 | 292 | Storage.Abstractions |
