...
![Coverage gate](https://img.shields.io/badge/coverage%20gate-line%20%E2%89%A5%2068%25%20%7C%20branch%20%E2%89%A5%2064%25-blue)
...
58 projects, 53,257 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Mediator.Runtime` | 16 | 1,387 | Mediator.Abstractions |
...
| `KyrolusSous.EndpointKit.EF` | 24 | 5,107 | CQRS.EF, Caching.Abstractions, EndpointKit.Core, ExceptionHandling, ExceptionHandling.ProblemDetails, Repositories.EF.Abstractions, Validation.Abstractions |
