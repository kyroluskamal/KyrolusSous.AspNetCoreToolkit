...
135 projects, 109,299 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.

**Localization**

| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Localization.Abstractions` | 5 | 157 | - |
| `KyrolusSous.Localization.Json` | 6 | 344 | Localization.Abstractions |
| `KyrolusSous.Localization.StringLocalizer` | 3 | 63 | Localization.Abstractions |
...
| `KyrolusSous.Validation.DataAnnotations` | 2 | 166 | Validation.Abstractions |
| `KyrolusSous.Validation.DataAnnotations.Generator` | 1 | 516 | - |
| `KyrolusSous.Validation.Fluent` | 9 | 1,537 | Validation.Abstractions |
| `KyrolusSous.Validation.FluentValidation` | 5 | 598 | Validation.Abstractions, Validation.Fluent |
| `KyrolusSous.Validation.FluentValidation.Scanning` | 1 | 54 | Validation.FluentValidation |
| `KyrolusSous.Validation.Generator` | 1 | 212 | - |
| `KyrolusSous.Validation.Runtime` | 11 | 1,253 | Localization.Abstractions, Validation.Abstractions |
