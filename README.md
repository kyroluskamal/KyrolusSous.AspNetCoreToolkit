...
60 projects, 54,092 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Validation.Runtime` | 12 | 794 | Validation.Abstractions |
