...
131 projects, 104,674 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Validation.Abstractions` | 17 | 343 | - |
...
| `KyrolusSous.Validation.Fluent` | 8 | 856 | Validation.Abstractions |
| `KyrolusSous.Validation.FluentValidation` | 5 | 422 | Validation.Abstractions, Validation.Fluent |
| `KyrolusSous.Validation.FluentValidation.Scanning` | 1 | 26 | Validation.FluentValidation |
| `KyrolusSous.Validation.Generator` | 1 | 112 | - |
| `KyrolusSous.Validation.Runtime` | 12 | 797 | Validation.Abstractions |

**Exception handling**

| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.ExceptionHandling.Abstractions` | 27 | 664 | - |
| `KyrolusSous.ExceptionHandling.EntityFramework` | 2 | 67 | ExceptionHandling.Abstractions |
| `KyrolusSous.ExceptionHandling.FluentValidation` | 2 | 51 | ExceptionHandling.Abstractions |
| `KyrolusSous.ExceptionHandling.Marten` | 2 | 134 | ExceptionHandling.Abstractions |
| `KyrolusSous.ExceptionHandling.ProblemDetails` | 3 | 87 | ExceptionHandling.Runtime |
| `KyrolusSous.ExceptionHandling.Redis` | 2 | 61 | ExceptionHandling.Abstractions |
| `KyrolusSous.ExceptionHandling.Runtime` | 34 | 1,076 | ExceptionHandling.Abstractions |
