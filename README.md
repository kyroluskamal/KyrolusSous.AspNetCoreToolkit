...
60 projects, 54,132 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.ExceptionHandling` | 29 | 1,093 | ExceptionHandling.Abstractions |
...
| `KyrolusSous.EndpointKit.EF` | 24 | 5,110 | CQRS.EF, Caching.Abstractions, EndpointKit.Core, ExceptionHandling, ExceptionHandling.ProblemDetails, Validation.Abstractions |
| `KyrolusSous.EndpointKit.Generator` | 1 | 1,229 | - |
| `KyrolusSous.EndpointKit.Marten` | 24 | 5,192 | CQRS.Marten, Caching.Abstractions, EndpointKit.Core, ExceptionHandling, ExceptionHandling.ProblemDetails, Repositories.Marten.Abstractions, Validation.Abstractions |
