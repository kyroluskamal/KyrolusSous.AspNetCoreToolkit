...
98 projects, 83,644 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.DataProtection.Abstractions` | 20 | 210 | - |
...
| `KyrolusSous.DataProtection.Runtime` | 23 | 1,663 | DataProtection.Abstractions |
