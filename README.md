...
59 projects, 53,928 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Validation.DataAnnotations` | 2 | 63 | Validation.Abstractions |
