...
99 projects, 88,069 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Caching.Abstractions` | 30 | 2,275 | Compression.Abstractions |
| `KyrolusSous.Caching.MessagePack` | 3 | 138 | Caching.Abstractions |
| `KyrolusSous.Caching.Redis` | 24 | 4,443 | Caching.Abstractions |
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Elasticsearch` | 17 | 2,357 | Caching.Abstractions, Compression.Abstractions |
