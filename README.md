...
72 projects, 72,286 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Validation.Fluent` | 8 | 701 | Validation.Abstractions |
| `KyrolusSous.Validation.FluentValidation` | 5 | 306 | Validation.Abstractions |
