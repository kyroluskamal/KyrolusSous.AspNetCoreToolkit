...
131 projects, 104,654 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.ExceptionHandling.Abstractions` | 27 | 647 | - |
...
| `KyrolusSous.ExceptionHandling.Runtime` | 34 | 1,066 | ExceptionHandling.Abstractions |
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.EndpointKit.Core` | 39 | 3,498 | CQRS.Abstractions, Caching.Abstractions, Mediator.Abstractions, Validation.Abstractions |
| `KyrolusSous.EndpointKit.EF` | 24 | 5,144 | CQRS.EF, Caching.Abstractions, EndpointKit.Core, ExceptionHandling.ProblemDetails, ExceptionHandling.Runtime, Validation.Abstractions |
| `KyrolusSous.EndpointKit.Generator` | 1 | 1,229 | - |
| `KyrolusSous.EndpointKit.Marten` | 24 | 5,231 | CQRS.Marten, Caching.Abstractions, EndpointKit.Core, ExceptionHandling.ProblemDetails, ExceptionHandling.Runtime, Repositories.Marten.Abstractions, Validation.Abstractions |
