...
137 projects, 114,089 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.CQRS.Abstractions` | 46 | 2,172 | Mediator.Abstractions |
| `KyrolusSous.CQRS.Caching` | 8 | 441 | CQRS.Abstractions, Caching.Abstractions, Mediator.Abstractions |
| `KyrolusSous.CQRS.EF` | 54 | 2,375 | CQRS.Abstractions, Mediator.Abstractions, Repositories.EF.Abstractions |
| `KyrolusSous.CQRS.Elasticsearch` | 25 | 717 | CQRS.Abstractions, Caching.Abstractions, Elasticsearch, Elasticsearch.Abstractions, Mediator.Abstractions |
| `KyrolusSous.CQRS.ExceptionHandling` | 4 | 71 | Mediator.Abstractions |
| `KyrolusSous.CQRS.Mapping` | 2 | 23 | Mapping.Abstractions |
| `KyrolusSous.CQRS.Marten` | 50 | 1,898 | CQRS.Abstractions, Mediator.Abstractions, Repositories.Marten.Abstractions |
| `KyrolusSous.CQRS.Saga` | 11 | 681 | Mediator.Abstractions |
| `KyrolusSous.CQRS.Validation` | 3 | 81 | Mediator.Abstractions, Validation.Abstractions |
...
| `KyrolusSous.Elasticsearch.Abstractions` | 7 | 1,160 | - |
