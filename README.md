...
98 projects, 83,115 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.OpenApi` | 13 | 1,568 | - |
| `KyrolusSous.OpenApi.SwaggerUI` | 4 | 87 | OpenApi |
