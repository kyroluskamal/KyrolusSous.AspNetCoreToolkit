...
135 projects, 109,050 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Validation.Abstractions` | 19 | 1,005 | Localization.Abstractions |
...
| `KyrolusSous.Validation.Generator` | 1 | 147 | - |
| `KyrolusSous.Validation.Runtime` | 11 | 1,139 | Localization.Abstractions, Validation.Abstractions |
