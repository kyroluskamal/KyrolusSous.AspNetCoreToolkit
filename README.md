...
133 projects, 107,590 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.

**Localization**

| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Localization.Abstractions` | 3 | 58 | - |
| `KyrolusSous.Localization.Json` | 5 | 412 | Localization.Abstractions |
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Validation.Abstractions` | 18 | 911 | - |
...
| `KyrolusSous.Validation.Runtime` | 16 | 1,045 | Localization.Abstractions, Localization.Json, Validation.Abstractions |

**Exception handling**

| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.ExceptionHandling.Abstractions` | 28 | 1,386 | - |
...
| `KyrolusSous.ExceptionHandling.Runtime` | 35 | 1,353 | ExceptionHandling.Abstractions, Localization.Abstractions, Localization.Json |
...
| `KyrolusSous.Payments.Adyen` | 4 | 273 | Payments.Abstractions |
| `KyrolusSous.Payments.Checkout` | 4 | 256 | Payments.Abstractions |
| `KyrolusSous.Payments.Core` | 50 | 3,349 | Caching.Abstractions, Mediator.Abstractions, Payments.Abstractions |
| `KyrolusSous.Payments.Fawry` | 5 | 376 | Payments.Abstractions |
| `KyrolusSous.Payments.Klarna` | 4 | 172 | Payments.Abstractions |
| `KyrolusSous.Payments.Mollie` | 4 | 223 | Payments.Abstractions |
| `KyrolusSous.Payments.PayPal` | 6 | 748 | Payments.Abstractions |
| `KyrolusSous.Payments.Paymob` | 5 | 387 | Payments.Abstractions |
| `KyrolusSous.Payments.Square` | 4 | 231 | Payments.Abstractions |
| `KyrolusSous.Payments.Stripe` | 6 | 827 | Payments.Abstractions |
| `KyrolusSous.Payments.Tap` | 4 | 247 | Payments.Abstractions |
