...
62 projects, 56,474 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.ExceptionHandling.Abstractions` | 24 | 304 | - |
| `KyrolusSous.ExceptionHandling.EntityFramework` | 2 | 56 | ExceptionHandling.Abstractions |
| `KyrolusSous.ExceptionHandling.FluentValidation` | 2 | 47 | ExceptionHandling.Abstractions |
| `KyrolusSous.ExceptionHandling.ProblemDetails` | 2 | 76 | ExceptionHandling.Runtime |
| `KyrolusSous.ExceptionHandling.Redis` | 2 | 50 | ExceptionHandling.Abstractions |
| `KyrolusSous.ExceptionHandling.Runtime` | 27 | 1,019 | ExceptionHandling.Abstractions |
