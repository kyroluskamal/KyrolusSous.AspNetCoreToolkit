...
72 projects, 68,176 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Repositories.EF.Abstractions` | 42 | 2,774 | Caching.Abstractions |
| `KyrolusSous.Repositories.EF.Cache.Distributed` | 2 | 220 | Caching.Abstractions |
| `KyrolusSous.Repositories.EF.Generator` | 2 | 3,002 | - |
| `KyrolusSous.Repositories.EF.Runtime` | 16 | 3,602 | Repositories.EF.Abstractions |
