...
60 projects, 54,160 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Validation.FluentValidation` | 5 | 313 | Validation.Abstractions |
