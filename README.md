...
60 projects, 54,168 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Validation.FluentValidation` | 4 | 321 | Validation.Abstractions |
