...
72 projects, 69,147 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Repositories.Marten.Abstractions` | 42 | 3,027 | Caching.Abstractions |
| `KyrolusSous.Repositories.Marten.Generator` | 1 | 2,950 | - |
| `KyrolusSous.Repositories.Marten.Runtime` | 17 | 3,450 | ExceptionHandling.Runtime, Repositories.Marten.Abstractions |
...
| `KyrolusSous.CQRS.Caching` | 6 | 231 | CQRS.Abstractions, Caching.Abstractions, Mediator.Abstractions |
