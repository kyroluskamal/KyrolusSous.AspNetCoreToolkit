...
72 projects, 72,557 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.EndpointKit.Core` | 40 | 3,416 | CQRS.Abstractions, Caching.Abstractions, Mediator.Abstractions, Validation.Abstractions |
