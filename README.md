...
72 projects, 68,687 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Repositories.EF.Abstractions` | 45 | 2,908 | Caching.Abstractions |
| `KyrolusSous.Repositories.EF.Cache.Distributed` | 2 | 220 | Caching.Abstractions |
| `KyrolusSous.Repositories.EF.Generator` | 2 | 3,002 | - |
| `KyrolusSous.Repositories.EF.Runtime` | 21 | 3,979 | Repositories.EF.Abstractions |
