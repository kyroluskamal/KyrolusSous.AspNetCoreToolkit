...
135 projects, 107,844 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Validation.Abstractions` | 17 | 884 | Localization.Abstractions |
| `KyrolusSous.Validation.Caching` | 3 | 43 | Caching.Abstractions, Validation.Abstractions |
| `KyrolusSous.Validation.DataAnnotations` | 2 | 65 | Validation.Abstractions |
| `KyrolusSous.Validation.DataAnnotations.Generator` | 1 | 305 | - |
| `KyrolusSous.Validation.Fluent` | 9 | 1,249 | Validation.Abstractions |
| `KyrolusSous.Validation.FluentValidation` | 5 | 490 | Validation.Abstractions, Validation.Fluent |
| `KyrolusSous.Validation.FluentValidation.Scanning` | 1 | 26 | Validation.FluentValidation |
| `KyrolusSous.Validation.Generator` | 1 | 112 | - |
| `KyrolusSous.Validation.Runtime` | 11 | 796 | Localization.Abstractions, Validation.Abstractions |

**Exception handling**

| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.ExceptionHandling.Abstractions` | 26 | 1,322 | Localization.Abstractions |
| `KyrolusSous.ExceptionHandling.EntityFramework` | 2 | 102 | ExceptionHandling.Abstractions |
| `KyrolusSous.ExceptionHandling.FluentValidation` | 3 | 145 | ExceptionHandling.Abstractions |
| `KyrolusSous.ExceptionHandling.Marten` | 2 | 165 | ExceptionHandling.Abstractions |
| `KyrolusSous.ExceptionHandling.ProblemDetails` | 3 | 97 | ExceptionHandling.Runtime |
| `KyrolusSous.ExceptionHandling.Redis` | 2 | 61 | ExceptionHandling.Abstractions |
| `KyrolusSous.ExceptionHandling.Runtime` | 31 | 1,233 | ExceptionHandling.Abstractions, Localization.Abstractions |
