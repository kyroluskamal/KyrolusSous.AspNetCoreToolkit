...
71 projects, 59,652 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.ExceptionHandling.Runtime` | 34 | 997 | ExceptionHandling.Abstractions |

**Caching**

| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Caching.Abstractions` | 29 | 1,070 | Compression.Abstractions |
| `KyrolusSous.Caching.MessagePack` | 2 | 88 | Caching.Abstractions |
| `KyrolusSous.Caching.Redis` | 23 | 3,722 | Caching.Abstractions |
...
| `KyrolusSous.Compression.Core` | 6 | 550 | Compression.Abstractions |
...
| `KyrolusSous.Compression.Lz4` | 3 | 147 | Compression.Abstractions, Compression.Core |
