...
137 projects, 114,829 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Caching.Redis` | 24 | 4,505 | Caching.Abstractions |
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.CQRS.Abstractions` | 47 | 2,459 | Localization.Abstractions, Mediator.Abstractions |
| `KyrolusSous.CQRS.Caching` | 8 | 460 | CQRS.Abstractions, Caching.Abstractions, Mediator.Abstractions |
| `KyrolusSous.CQRS.EF` | 55 | 2,457 | CQRS.Abstractions, Mediator.Abstractions, Repositories.EF.Abstractions |
| `KyrolusSous.CQRS.Elasticsearch` | 26 | 825 | CQRS.Abstractions, Caching.Abstractions, Elasticsearch, Elasticsearch.Abstractions, Mediator.Abstractions |
| `KyrolusSous.CQRS.ExceptionHandling` | 4 | 71 | Mediator.Abstractions |
| `KyrolusSous.CQRS.Mapping` | 2 | 23 | Mapping.Abstractions |
| `KyrolusSous.CQRS.Marten` | 50 | 1,963 | CQRS.Abstractions, Mediator.Abstractions, Repositories.Marten.Abstractions |
| `KyrolusSous.CQRS.Saga` | 11 | 773 | Mediator.Abstractions |
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Elasticsearch` | 13 | 2,900 | Caching.Abstractions, Compression.Abstractions, Elasticsearch.Abstractions, Resilience.Abstractions |
| `KyrolusSous.Elasticsearch.Abstractions` | 7 | 1,186 | - |
...
| **`-850`**  | `KyrolusAuditBehavior`                                                              | Captures audit records to `IKyrolusAuditSink` with automatic sensitive credential redaction. |
| **`-800`**  | `KyrolusIdempotencyBehavior`                                                        | Guarantees command deduplication via cache keys (`IKyrolusIdempotentCommand`).               |
