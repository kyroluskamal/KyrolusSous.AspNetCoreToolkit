...
137 projects, 118,719 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Gateway.Abstractions` | 7 | 117 | - |
| `KyrolusSous.Gateway.Yarp` | 8 | 491 | Auth.TokenRevocation, Gateway.Abstractions |
