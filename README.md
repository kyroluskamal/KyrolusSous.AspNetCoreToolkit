...
99 projects, 86,897 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.RabbitMQ.Abstractions` | 21 | 665 | - |
| `KyrolusSous.RabbitMQ.Runtime` | 22 | 2,390 | RabbitMQ.Abstractions |
