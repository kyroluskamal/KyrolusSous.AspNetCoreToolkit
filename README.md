...
62 projects, 56,881 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.ExceptionHandling.Runtime` | 34 | 1,000 | ExceptionHandling.Abstractions |
