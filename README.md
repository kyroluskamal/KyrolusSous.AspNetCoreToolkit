...
57 projects, 52,196 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Mediator.Generator` | 4 | 1,286 | - |
| `KyrolusSous.Mediator.Runtime` | 14 | 1,397 | Mediator.Abstractions |
