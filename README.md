...
99 projects, 85,229 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.RabbitMQ.Abstractions` | 11 | 325 | - |
| `KyrolusSous.RabbitMQ.Runtime` | 10 | 1,062 | RabbitMQ.Abstractions |
