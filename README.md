...
137 projects, 122,838 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.EndpointKit.Core` | 53 | 4,399 | CQRS.Abstractions, Caching.Abstractions, Mediator.Abstractions, Validation.Abstractions |
...
| `KyrolusSous.Gateway.Abstractions` | 17 | 863 | - |
| `KyrolusSous.Gateway.Yarp` | 19 | 3,149 | Auth.MultiTenancy, Auth.TokenRevocation, Gateway.Abstractions |
