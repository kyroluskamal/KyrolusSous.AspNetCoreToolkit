...
62 projects, 56,859 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.ExceptionHandling.Abstractions` | 27 | 692 | - |
...
| `KyrolusSous.ExceptionHandling.Runtime` | 34 | 996 | ExceptionHandling.Abstractions |
