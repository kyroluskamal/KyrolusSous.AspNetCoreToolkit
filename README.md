...
72 projects, 72,256 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Mediator.Reflection` | 4 | 526 | Mediator.Abstractions, Mediator.Runtime |
