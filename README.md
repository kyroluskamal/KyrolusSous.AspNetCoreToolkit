...
137 projects, 116,347 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Mediator.Generator`    |     4 | 2,517 | -                                       |
...
| Project                            | Files | Lines | Depends on           |
| ---------------------------------- | ----: | ----: | -------------------- |
| `KyrolusSous.Mapping.Abstractions` |    16 |   853 | -                    |
...
| Project                              | Files | Lines | Depends on                                                                                                |
| ------------------------------------ | ----: | ----: | --------------------------------------------------------------------------------------------------------- |
| `KyrolusSous.CQRS.Abstractions`      |    49 | 2,670 | Localization.Abstractions, Mediator.Abstractions                                                          |
| `KyrolusSous.CQRS.Caching`           |     9 |   635 | CQRS.Abstractions, Caching.Abstractions, Mediator.Abstractions                                            |
| `KyrolusSous.CQRS.EF`                |    56 | 2,653 | CQRS.Abstractions, Mediator.Abstractions, Repositories.EF.Abstractions                                    |
...
| `KyrolusSous.CQRS.Mapping`           |     9 |   570 | CQRS.Abstractions, Mapping.Abstractions                                                                   |
| `KyrolusSous.CQRS.Marten`            |    53 | 2,157 | CQRS.Abstractions, Mediator.Abstractions, Repositories.Marten.Abstractions                                |
| `KyrolusSous.CQRS.Saga`              |    11 |   801 | Mediator.Abstractions                                                                                     |
| `KyrolusSous.CQRS.Validation`        |     4 |   110 | Mediator.Abstractions, Validation.Abstractions                                                            |
...
| `KyrolusSous.EndpointKit.EF`        |    24 | 5,147 | CQRS.EF, Caching.Abstractions, EndpointKit.Core, ExceptionHandling.ProblemDetails, ExceptionHandling.Runtime, Validation.Abstractions                                       |
| `KyrolusSous.EndpointKit.Generator` |     1 | 1,229 | -                                                                                                                                                                           |
| `KyrolusSous.EndpointKit.Marten`    |    24 | 5,236 | CQRS.Marten, Caching.Abstractions, EndpointKit.Core, ExceptionHandling.ProblemDetails, ExceptionHandling.Runtime, Repositories.Marten.Abstractions, Validation.Abstractions |
