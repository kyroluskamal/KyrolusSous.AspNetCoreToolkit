...
58 projects, 53,259 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Mediator.Runtime` | 16 | 1,389 | Mediator.Abstractions |
