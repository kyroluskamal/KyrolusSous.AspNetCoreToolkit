...
114 projects, 94,010 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.FeatureManagement.Abstractions` | 1 | 28 | - |
| `KyrolusSous.FeatureManagement.Core` | 1 | 144 | FeatureManagement.Abstractions |
| `KyrolusSous.Gateway.Abstractions` | 1 | 32 | - |
| `KyrolusSous.Gateway.Yarp` | 1 | 120 | Auth.TokenRevocation, Gateway.Abstractions |
| `KyrolusSous.Http.Abstractions` | 1 | 22 | - |
| `KyrolusSous.Http.Core` | 1 | 110 | Http.Abstractions, Resilience.Abstractions |
| `KyrolusSous.Notifications.Abstractions` | 1 | 68 | - |
| `KyrolusSous.Notifications.Core` | 1 | 145 | Notifications.Abstractions, Resilience.Abstractions |
| `KyrolusSous.Notifications.Smtp` | 1 | 94 | Notifications.Abstractions |
| `KyrolusSous.Scheduling.Abstractions` | 1 | 34 | - |
| `KyrolusSous.Scheduling.Core` | 1 | 196 | Scheduling.Abstractions |
| `KyrolusSous.Storage.Abstractions` | 3 | 226 | Compression.Abstractions |
| `KyrolusSous.Storage.FileSystem` | 1 | 199 | Storage.Abstractions |
