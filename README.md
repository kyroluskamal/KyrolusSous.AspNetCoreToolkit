...
60 projects, 54,227 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Mediator.Runtime` | 16 | 1,374 | Mediator.Abstractions |

**Validation**

| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Validation.Abstractions` | 17 | 324 | - |
| `KyrolusSous.Validation.DataAnnotations` | 2 | 57 | Validation.Abstractions |
| `KyrolusSous.Validation.DataAnnotations.Generator` | 1 | 305 | - |
| `KyrolusSous.Validation.Fluent` | 8 | 684 | Validation.Abstractions |
| `KyrolusSous.Validation.FluentValidation` | 4 | 238 | Validation.Abstractions |
| `KyrolusSous.Validation.FluentValidation.Scanning` | 1 | 19 | Validation.FluentValidation |
| `KyrolusSous.Validation.Generator` | 1 | 112 | - |
| `KyrolusSous.Validation.Runtime` | 11 | 917 | Validation.Abstractions |

**Exception handling**

| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.ExceptionHandling` | 30 | 1,138 | ExceptionHandling.Abstractions |
| `KyrolusSous.ExceptionHandling.Abstractions` | 23 | 267 | - |
...
| `KyrolusSous.ExceptionHandling.ProblemDetails` | 2 | 76 | ExceptionHandling |
...
| `KyrolusSous.Repositories.Marten.Runtime` | 14 | 3,222 | ExceptionHandling, Repositories.Marten.Abstractions |
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.EndpointKit.Core` | 31 | 2,878 | CQRS.Abstractions, Caching.Abstractions, Mediator.Abstractions |
| `KyrolusSous.EndpointKit.EF` | 24 | 5,107 | CQRS.EF, Caching.Abstractions, EndpointKit.Core, ExceptionHandling, ExceptionHandling.ProblemDetails, Validation.Abstractions |
| `KyrolusSous.EndpointKit.Generator` | 1 | 1,229 | - |
| `KyrolusSous.EndpointKit.Marten` | 24 | 5,189 | CQRS.Marten, Caching.Abstractions, EndpointKit.Core, ExceptionHandling, ExceptionHandling.ProblemDetails, Repositories.Marten.Abstractions, Validation.Abstractions |
