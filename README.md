...
99 projects, 87,680 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Caching.Abstractions` | 30 | 2,054 | Compression.Abstractions |
...
| `KyrolusSous.Auth.EntityFramework` | 3 | 270 | Auth.Abstractions |
...
| `KyrolusSous.Auth.MagicLink` | 4 | 260 | Auth.Abstractions |
| `KyrolusSous.Auth.Marten` | 3 | 223 | Auth.Abstractions |
...
| `KyrolusSous.Auth.Sessions` | 4 | 331 | Auth.Abstractions |
| `KyrolusSous.Auth.TokenRevocation` | 3 | 236 | Auth.Abstractions |
| `KyrolusSous.Auth.Tokens` | 3 | 255 | Auth.Abstractions |
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Elasticsearch` | 17 | 2,185 | Caching.Abstractions, Compression.Abstractions |
...
| `KyrolusSous.RabbitMQ.Runtime` | 24 | 2,623 | Compression.Abstractions, RabbitMQ.Abstractions |
