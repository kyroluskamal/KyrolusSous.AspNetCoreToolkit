...
99 projects, 87,142 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Compression.Core` | 6 | 572 | Compression.Abstractions |
