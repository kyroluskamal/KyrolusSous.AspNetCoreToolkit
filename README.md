...
131 projects, 104,659 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.EndpointKit.Marten` | 24 | 5,234 | CQRS.Marten, Caching.Abstractions, EndpointKit.Core, ExceptionHandling.ProblemDetails, ExceptionHandling.Runtime, Repositories.Marten.Abstractions, Validation.Abstractions |
