...
136 projects, 113,008 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.CQRS.Abstractions` | 43 | 1,992 | Mediator.Abstractions |
| `KyrolusSous.CQRS.Caching` | 8 | 441 | CQRS.Abstractions, Caching.Abstractions, Mediator.Abstractions |
| `KyrolusSous.CQRS.EF` | 53 | 2,309 | CQRS.Abstractions, Mediator.Abstractions, Repositories.EF.Abstractions |
| `KyrolusSous.CQRS.ExceptionHandling` | 4 | 63 | Mediator.Abstractions |
| `KyrolusSous.CQRS.Mapping` | 2 | 23 | Mapping.Abstractions |
| `KyrolusSous.CQRS.Marten` | 49 | 1,825 | CQRS.Abstractions, Mediator.Abstractions, Repositories.Marten.Abstractions |
| `KyrolusSous.CQRS.Saga` | 11 | 662 | Mediator.Abstractions |
| `KyrolusSous.CQRS.Validation` | 3 | 73 | Mediator.Abstractions, Validation.Abstractions |
