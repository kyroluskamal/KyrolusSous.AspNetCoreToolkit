...
62 projects, 56,865 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.ExceptionHandling.Abstractions` | 27 | 710 | - |
...
| `KyrolusSous.ExceptionHandling.Runtime` | 34 | 984 | ExceptionHandling.Abstractions |
...
```csharp
// Built-in handlers for Culture, JSON, Arguments, Sockets, HTTP, Timeouts, NotFound, Unauthorized, SSL, and General exceptions:
builder.Services.AddExceptionHandler<CultureNotFoundExceptionHandler>();
...
builder.Services.AddExceptionHandler<SslAuthenticationExceptionHandler>();
