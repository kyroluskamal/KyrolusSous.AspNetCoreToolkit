...
57 projects, 50,411 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Mediator.Abstractions` | 24 | 401 | - |
| `KyrolusSous.Mediator.Generator` | 2 | 1,082 | - |
| `KyrolusSous.Mediator.Runtime` | 12 | 791 | Mediator.Abstractions |
