...
99 projects, 84,353 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.DataProtection.Runtime` | 24 | 2,075 | DataProtection.Abstractions |
| `KyrolusSous.DataProtection.Vault` | 3 | 206 | DataProtection.Abstractions |
