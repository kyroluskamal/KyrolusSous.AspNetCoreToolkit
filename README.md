...
135 projects, 110,020 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Mediator.Abstractions` | 25 | 1,393 | - |
| `KyrolusSous.Mediator.Generator` | 4 | 1,833 | - |
| `KyrolusSous.Mediator.Reflection` | 4 | 539 | Mediator.Abstractions, Mediator.Runtime |
| `KyrolusSous.Mediator.Runtime` | 16 | 1,268 | Mediator.Abstractions |
