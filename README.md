...
113 projects, 94,008 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Elasticsearch` | 20 | 4,014 | Caching.Abstractions, Compression.Abstractions, Resilience.Abstractions |
