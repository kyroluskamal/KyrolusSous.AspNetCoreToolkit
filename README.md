...
137 projects, 119,817 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.EndpointKit.Core` | 47 | 3,903 | CQRS.Abstractions, Caching.Abstractions, Mediator.Abstractions, Validation.Abstractions |
...
| `KyrolusSous.Gateway.Abstractions` | 11 | 520 | - |
| `KyrolusSous.Gateway.Yarp` | 11 | 1,186 | Auth.TokenRevocation, Gateway.Abstractions |
