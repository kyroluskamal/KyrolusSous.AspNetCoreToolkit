...
58 projects, 53,215 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Mediator.Reflection` | 4 | 480 | Mediator.Abstractions, Mediator.Runtime |
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Repositories.EF.Abstractions` | 32 | 2,350 | Caching.Abstractions |
