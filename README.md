...
60 projects, 54,270 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.ExceptionHandling.Abstractions` | 23 | 254 | - |
...
| `KyrolusSous.ExceptionHandling.Runtime` | 27 | 1,018 | ExceptionHandling.Abstractions |
