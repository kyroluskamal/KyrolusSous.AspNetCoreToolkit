...
134 projects, 107,794 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Validation.Runtime` | 11 | 789 | Localization.Abstractions, Validation.Abstractions |
