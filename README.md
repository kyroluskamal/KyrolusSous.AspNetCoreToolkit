...
119 projects, 95,459 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.FeatureManagement.Abstractions` | 1 | 36 | - |
| `KyrolusSous.FeatureManagement.Core` | 1 | 260 | FeatureManagement.Abstractions |
...
| `KyrolusSous.Scheduling.Abstractions` | 1 | 62 | - |
| `KyrolusSous.Scheduling.Core` | 1 | 290 | Scheduling.Abstractions |
| `KyrolusSous.Scheduling.Redis` | 1 | 53 | Scheduling.Abstractions |
| `KyrolusSous.Storage.Abstractions` | 3 | 293 | Compression.Abstractions |
| `KyrolusSous.Storage.FileSystem` | 1 | 338 | Storage.Abstractions |
| `KyrolusSous.Storage.S3` | 1 | 319 | Storage.Abstractions |
