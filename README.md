...
99 projects, 86,684 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.RabbitMQ.Runtime` | 22 | 2,177 | RabbitMQ.Abstractions |
