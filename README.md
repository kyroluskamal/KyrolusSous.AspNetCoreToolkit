...
131 projects, 98,439 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Payments.Abstractions` | 2 | 145 | - |
| `KyrolusSous.Payments.Adyen` | 1 | 255 | Payments.Abstractions |
| `KyrolusSous.Payments.Checkout` | 1 | 238 | Payments.Abstractions |
| `KyrolusSous.Payments.Core` | 1 | 191 | Payments.Abstractions |
| `KyrolusSous.Payments.Fawry` | 1 | 276 | Payments.Abstractions |
| `KyrolusSous.Payments.Klarna` | 1 | 155 | Payments.Abstractions |
| `KyrolusSous.Payments.Mollie` | 1 | 207 | Payments.Abstractions |
| `KyrolusSous.Payments.PayPal` | 1 | 336 | Payments.Abstractions |
| `KyrolusSous.Payments.Paymob` | 1 | 288 | Payments.Abstractions |
| `KyrolusSous.Payments.Square` | 1 | 214 | Payments.Abstractions |
| `KyrolusSous.Payments.Stripe` | 1 | 374 | Payments.Abstractions |
| `KyrolusSous.Payments.Tap` | 1 | 229 | Payments.Abstractions |
