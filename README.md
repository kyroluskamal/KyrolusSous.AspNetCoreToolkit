...
62 projects, 56,763 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.ExceptionHandling.Runtime` | 29 | 969 | ExceptionHandling.Abstractions |
