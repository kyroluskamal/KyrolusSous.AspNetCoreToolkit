...
136 projects, 113,366 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project                              | Files | Lines | Depends on                                                                 |
| ------------------------------------ | ----: | ----: | -------------------------------------------------------------------------- |
| `KyrolusSous.CQRS.Abstractions`      |    46 | 2,174 | Mediator.Abstractions                                                      |
| `KyrolusSous.CQRS.Caching`           |     8 |   441 | CQRS.Abstractions, Caching.Abstractions, Mediator.Abstractions             |
| `KyrolusSous.CQRS.EF`                |    54 | 2,377 | CQRS.Abstractions, Mediator.Abstractions, Repositories.EF.Abstractions     |
...
| `KyrolusSous.EndpointKit.EF`        |    24 | 5,149 | CQRS.EF, Caching.Abstractions, EndpointKit.Core, ExceptionHandling.ProblemDetails, ExceptionHandling.Runtime, Validation.Abstractions                                       |
