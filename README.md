...
99 projects, 86,057 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.RabbitMQ.Abstractions` | 17 | 506 | - |
| `KyrolusSous.RabbitMQ.Runtime` | 17 | 1,709 | RabbitMQ.Abstractions |
