...
131 projects, 104,668 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.EndpointKit.EF` | 24 | 5,138 | CQRS.EF, Caching.Abstractions, EndpointKit.Core, ExceptionHandling.ProblemDetails, ExceptionHandling.Runtime, Validation.Abstractions |
| `KyrolusSous.EndpointKit.Generator` | 1 | 1,229 | - |
| `KyrolusSous.EndpointKit.Marten` | 24 | 5,225 | CQRS.Marten, Caching.Abstractions, EndpointKit.Core, ExceptionHandling.ProblemDetails, ExceptionHandling.Runtime, Repositories.Marten.Abstractions, Validation.Abstractions |
