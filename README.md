...
72 projects, 69,644 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| `KyrolusSous.Repositories.Marten.Runtime` | 21 | 3,799 | ExceptionHandling.Runtime, Repositories.Marten.Abstractions |
