...
61 projects, 55,826 lines of C#. Grouped by area; `Abstractions` packages hold contracts only and carry no runtime dependency.
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.ExceptionHandling.Abstractions` | 24 | 316 | - |
...
| `KyrolusSous.ExceptionHandling.Runtime` | 27 | 1,034 | ExceptionHandling.Abstractions |
...
| Project | Files | Lines | Depends on |
| --- | ---: | ---: | --- |
| `KyrolusSous.Elasticsearch` | 15 | 1,478 | - |
